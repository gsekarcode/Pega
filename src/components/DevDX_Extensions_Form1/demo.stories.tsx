...
import DevDXExtensionsForm1 from './index';
...
const meta: Meta<typeof DevDXExtensionsForm1> = {
  title: 'DevDXExtensionsForm1',
  component: DevDXExtensionsForm1,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Form'
  }
...
export default meta;
type Story = StoryObj<typeof DevDXExtensionsForm1>;
...
export const BaseDevDXExtensionsForm1: Story = args => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <>
      <DevDXExtensionsForm1 {...props} {...args}>{regionAChildren}</DevDXExtensionsForm1>
    </>
  );
};

BaseDevDXExtensionsForm1.args = {
  showLabel: true,
  label: 'Form template',
  NumCols: 1,
};

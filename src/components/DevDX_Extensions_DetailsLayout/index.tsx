...
import StyledDevDxExtensionsDetailsLayoutWrapper, { StyledDetailsGridContainer, StyledHighlightedFieldsHrLine } from './styles';

// includes in bundle
import { getAllFields } from './utils';

// interface for props
interface DevDxExtensionsDetailsLayoutProps extends PConnFieldProps {
...
function DevDxExtensionsDetailsLayout(props: DevDxExtensionsDetailsLayoutProps) {
  ...
  return (
    <StyledDevDxExtensionsDetailsLayoutWrapper>
...
export default withConfiguration(DevDxExtensionsDetailsLayout);

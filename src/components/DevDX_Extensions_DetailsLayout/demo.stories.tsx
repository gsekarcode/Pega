...
import DevDxExtensionsDetailsLayout from './index';
...
const meta: Meta<typeof DevDxExtensionsDetailsLayout> = {
  title: 'DevDxExtensionsDetailsLayout',
  component: DevDxExtensionsDetailsLayout,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof DevDxExtensionsDetailsLayout>;
...
export const BaseDevDxExtensionsDetailsLayout: Story = args => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <>
      <DevDxExtensionsDetailsLayout {...props} {...args}>
        <Region
          {...{
            getPConnect: () => ({
              setInheritedProp: () => {},
        ...
        />
      </DevDxExtensionsDetailsLayout>
    </>
  );
};

BaseDevDxExtensionsDetailsLayout.args = {
  showLabel: true,
